    ...
    <div className="bg-gray-50 min-h-screen py-10 px-5 md:px-20">
      <div className="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-8">
        ...
        <p className="text-gray-700 mb-6">
         Abroad Educares values your privacy and is
          committed to protecting your personal information. This Privacy
          Policy explains how we collect, use, and safeguard your information
          when you visit our website. Please
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside text-gray-700">
            <li>
              ...
              address, phone number, or any other information you provide
              through forms or inquiries.
            </li>
            <li>
              <strong>Information We Collect Automatically:</strong> Information
              about how you interact with our Website, such as IP address,
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside text-gray-700">
            <li>To provide and manage our Website and services.</li>
            <li>To send you updates, promotional offers, and other communications.</li>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside text-gray-700">
            <li>
              <strong>Service Providers:</strong> Vendors or contractors who
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside text-gray-700">
            ...
            <li>
              <strong>Opt-Out:</strong> Unsubscribe from promotional emails.
            </li>
            <li>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700">
            ...
            protect your information. However, no online platform can guarantee
            absolute security. Please notify us immediately if you suspect any
        ...
        <section className="mb-8">
          ...
          <ul className="text-gray-700">
            <li>
              <strong>Email:</strong> support@abroadeducares.com
            </li>
            <li>
              <strong>Phone:</strong> +91-9501919187, +91-8143900003
            </li>
            <li>
              <strong>Mailing Address:</strong>  SCO No. 4, First Floor, La Prisma Market, Nagla Rd, Zirakpur, Punjab 140603
            </li>
          </ul>
        </section>
      </div>
